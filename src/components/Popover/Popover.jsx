...
export const Popover = ({ children, clickOut, type = '' }) => {
  let styleWindow = 'bg-slate-50 p-4 sm:p-8 rounded-md max-h-[90vh] border z-20 flex flex-col overflow-y-auto';

  if (type === 'confirm') {
    styleWindow = styleWindow + 'w-[300px] min-w-[100px] sm:min-w-[200px] md:min-w-[250px] xl:min-w-[300px] mx-4';
  } else {
    styleWindow = styleWindow + 'w-[300px] w-fit min-w-[350px] mx-[20px] sm:w-[500px] md:w-[650px] xl:min-w-[950px] w-min mx-4';
  }
