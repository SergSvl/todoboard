    ...
    <>
      ...
      {isCardOpenned && (
        <Popover clickOut={clickOutHandler}>
          {isEditTitleIn ? (
            ...
            <div
              className='w-full text-center mb-4 font-semibold hover:cursor-pointer'
          ...
          {isEditDescription ? (
            <>
              ...
              ></textarea>
              <button
                className='btn rounded-md bg-sky-400 text-white py-2 px-8 mx-auto relative'
            ...
            <div
              className='w-full text-left p-3 mb-4 overflow-x-hidden whitespace-pre-wrap'
              onClick={editDescriptionHandler}
            >
              {card.description}
            </div>
      ...
      >
        <div className='flex justify-beetwen mb-1'>
          {isEditTitleOut ? (
            <input
              className='w-full border rounded-md h-6 px-2 mb-0'
